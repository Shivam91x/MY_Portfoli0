        ...
        <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-2">
          ...
          <div className="relative flex justify-center ">
            ...
            <img
              src="./demo.png"
              alt="Why hire me"
              className="relative z-10 h-[360px] w-auto rounded-2xl object-content md:h-[360px]"
            />
          </div>

          {/* Right: Content */}
          <div className="">
            <h2 className=" text-4xl text-gray-900 md:text-4xl">
            ...
            <div className="pt-4">
              <a
                href="#contact"
                className="inline-flex items-center px-6 py-3 text-black border rounded-3xl shadow-3xl transition hover:bg-orange-600 hover:text-white"
              >
                Hire me
              </a>
            </div>
