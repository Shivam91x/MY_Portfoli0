        ...
        <div className="rounded-3xl border border-orange-100 bg-white p-6 shadow-sm sm:p-8">
          ...
          <form onSubmit={sendEmail} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 px-11 py-3 text-sm outline-none  focus:border-orange-400 focus:border-2 hover:border-orange-400"
                  required
                />
              </div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm outline-none focus:border-orange-400 focus:border-2 hover:border-orange-400 "
              required
            />
